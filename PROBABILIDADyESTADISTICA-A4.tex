...
% $\divideontimes$ ejercicio difÃ­cil
...
%\includeonly{TEMA00_chapter} %para ver solo esto, o VARIOS separado por comas
...
\appendix
\include{APENDICES}
%\include{TEMA99_chapter} % QUITAR en versión final ***************
